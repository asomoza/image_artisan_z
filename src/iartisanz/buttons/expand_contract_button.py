...
from iartisanz.buttons.base_menu_button import BaseMenuButton


class ExpandContractButton(BaseMenuButton):
    CONTRACT_ICON = files("iartisanz.theme.icons").joinpath("chevron_right.png")
    EXPAND_ICON = files("iartisanz.theme.icons").joinpath("chevron_left.png")
