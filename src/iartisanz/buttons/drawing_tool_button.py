...
class DrawingToolButton(QWidget):
    ...
    def on_brush_clicked(self):
        self._set_button_states(True, False, False, False, False, False)
        self.draw_tool = "brush"
        self.erase_mode = False
        self._emit_tool()

    def on_eraser_clicked(self):
        self._set_button_states(False, True, False, False, False, False)
        self.draw_tool = "brush"
        self.erase_mode = True
        self._emit_tool()

    def on_square_outline_clicked(self):
        self._set_button_states(False, False, True, False, False, False)
        self.draw_tool = "square_outline"
        self.erase_mode = False
        self._emit_tool()

    def on_square_fill_clicked(self):
        self._set_button_states(False, False, False, True, False, False)
        self.draw_tool = "square_fill"
        self.erase_mode = False
        self._emit_tool()

    def on_circle_outline_clicked(self):
        self._set_button_states(False, False, False, False, True, False)
        self.draw_tool = "circle_outline"
        self.erase_mode = False
        self._emit_tool()

    def on_circle_fill_clicked(self):
        self._set_button_states(False, False, False, False, False, True)
