...
class ControlNetMaskDialog(BaseDialog):
    """Dialog for creating/editing ControlNet spatial/inpainting masks.

    This dialog provides mask editing functionality for ControlNet. The mask serves
    dual purposes depending on context:
    ...
    The base image for mask editing comes from source_image (via SourceImageDialog),
    not from a separate ControlNet init_image.
    """
    ...
    def __init__(
        ...
        *args,
        ...
        self.setWindowTitle("ControlNet Region Mask")
    ...
    def init_ui(self):
        ...
        info_label = QLabel(
            "Define where ControlNet applies its guidance.\n"
            "White = full control, Black = no control, Gray = partial."
        )
        ...
        # Mask editing widget (simplified - always visible)
